		...
		<nav class="navbar navbar-inverse">
			<div class="container-fluid">
				<div class="navbar-header">
					<a class="navbar-brand" href="#">LetsShop.in</a>
				</div>
			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active" style="width: 100%; height: 400">
						<img src=<c:url value="http://mobiles.sulekhalive.com/content/mstore/14928607/albums/default/original/iphone-6c.jpg" /> alt="iphone-6c">
					</div>

					<div class="item" style="width: 100%; height: 400">
						<img src=<c:url value="http://www.blogcdn.com/www.luxist.com/media/2010/01/philip-stein-fruitz-ladies-watches.jpg" /> alt="watches">
					</div>

					<div class="item" style="width: 100%; height: 400">
						<img src=<c:url value="https://shopswell-com-prod.s3.amazonaws.com/assets/8f92d408-8445-4c32-aca8-10c47658511e/hp-chromebook-14-cover.jpg" /> alt="hp-chromebook">
					</div>
